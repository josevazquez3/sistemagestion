...
type ModalVerDocumentoOrdenDiaProps = {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  documento: DocumentoOrdenDia | null;
};

export function ModalVerDocumentoOrdenDia({
  open,
  onOpenChange,
  documento,
}: ModalVerDocumentoOrdenDiaProps) {
  if (!documento) return null;

  const handleDownload = () => {
    window.open(`/api/secretaria/orden-del-dia/${documento.id}/download`, "_blank");
  };
