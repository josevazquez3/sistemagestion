...
type ModelosOficioTablaProps = {
  modelos: ModeloOficio[];
  loading: boolean;
...
export function ModelosOficioTabla({
  modelos,
  loading,
  selectedIds,
  onSelectAll,
            ...
            <TableBody>
              {modelos.length === 0 ? (
                <TableRow>
                  ...
                  >
                    No hay modelos de oficios. Subí uno con &quot;Subir modelo&quot;.
                  </TableCell>
                </TableRow>
              ) : (
                modelos.map((m) => (
                  <TableRow key={m.id}>
                    ...
                    <TableCell>{m.tipoOficio.nombre}</TableCell>
